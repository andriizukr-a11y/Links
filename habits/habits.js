  ...
  const renderHabitCard = (habit) => {
    ...
    const streak =
      typeof getStreak === "function"
        ...
        : 0;
    const brokenStreak =
      streak === 0 && typeof getBrokenStreak === "function"
        ? getBrokenStreak(habit.dates, habit.skippedDates, habit.type)
        : 0;
    const showBrokenStreak = brokenStreak > 1;
    const longest =
          ...
          <div class="habit-header">
            ...
            <div class="habit-top-right" style="margin-left: auto; display: flex; align-items: center; gap: 8px;">
              ${
                streak > 0
                  ? `
              <div class="streak-badge done-streak${habitType === "bad" ? "bad-streak" : ""}" title="Серія: ${streak} днів поспіль">
              ...
              `
                  : showBrokenStreak
                    ? `
              <div class="streak-badge broken-streak" title="Не виконувалося: ${brokenStreak} днів">
                ...
                <span class="streak-count">${brokenStreak}</span>
              </div>
              `
                    : ""
              }
